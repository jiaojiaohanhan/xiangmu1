...
<!--        --><?php //foreach($notices as $notice) if($notice->notice_id==1){ ?>
            <li style="list-style: none;margin-bottom: 5px"><h3>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $notice->notice_title;?></h3></li>
            <li style="list-style: none;margin-bottom: 20px"><p>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $notice->notice_cont;?></p></li>
        <?php } ?>
    </ul>
</div>
</body>
